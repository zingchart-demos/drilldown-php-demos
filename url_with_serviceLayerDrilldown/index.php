...
<html>
<head>
  <title>ZC-PHP Service Layer Drilldown</title>
...
// data-query-parameter is define in $originalSeries as a custom ZingChart token
// custom tokens are accessed by the dashed cased prefixed with % sign
$drilldownChartUrl = "drilldown_echo_charts.php?seriesId=%data-queryParameter";
...
$originalConfig = array(
  ...
  "graphset" => array(
    array(
      ...
      "plot" => array(
        "url" =>  $drilldownChartUrl, // drilldown chart url here!
        "target" =>  "graph",
        "refAngle" =>  270,
        "decimals" =>  0,
        "thousandsSeparator" =>  ",",
